...
Source0  : https://files.pythonhosted.org/packages/e2/43/d99899bfa24a3914f0318536918ab8c91c09350b5482e4e9bb7291840ae3/isort-5.11.3.tar.gz
...
%prep
%setup -q -n isort-5.11.3
cd %{_builddir}/isort-5.11.3
pushd ..
cp -a isort-5.11.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671474014
