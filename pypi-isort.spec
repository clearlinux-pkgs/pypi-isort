...
Source0  : https://files.pythonhosted.org/packages/d7/1a/a43e2f3e6928fa210b03758a2a397898aa7381c480e3bfac121707d233cc/isort-5.11.1.tar.gz
...
%prep
%setup -q -n isort-5.11.1
cd %{_builddir}/isort-5.11.1
pushd ..
cp -a isort-5.11.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670891260
