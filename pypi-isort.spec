...
Source0  : https://files.pythonhosted.org/packages/a9/c4/dc00e42c158fc4dda2afebe57d2e948805c06d5169007f1724f0683010a9/isort-5.12.0.tar.gz
...
%prep
%setup -q -n isort-5.12.0
cd %{_builddir}/isort-5.12.0
pushd ..
cp -a isort-5.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674942836
