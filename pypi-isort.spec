...
Source0  : https://files.pythonhosted.org/packages/1c/28/b382d1656ac0ee4cef4bf579b13f9c6c813bff8a5cb5996669592c8c75fa/isort-6.0.0.tar.gz
...
%prep
%setup -q -n isort-6.0.0
cd %{_builddir}/isort-6.0.0
pushd ..
cp -a isort-6.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738079732
