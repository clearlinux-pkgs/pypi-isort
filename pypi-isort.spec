...
Source0  : https://files.pythonhosted.org/packages/42/48/d46b8a013e2f9c6f639197b1d96791196133d8a36a5b594529cfdb780a8d/isort-5.11.2.tar.gz
...
%prep
%setup -q -n isort-5.11.2
cd %{_builddir}/isort-5.11.2
pushd ..
cp -a isort-5.11.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671037258
