...
%prep
%setup -q -n isort-5.10.1
cd %{_builddir}/isort-5.10.1
pushd ..
cp -a isort-5.10.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656383083
...
cp %{_builddir}/isort-5.10.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-isort/00afc6bf25b2c1776f00c130bbf4397210ce7766
cp %{_builddir}/isort-5.10.1/isort/_vendored/tomli/LICENSE %{buildroot}/usr/share/package-licenses/pypi-isort/9da6ca26337a886fb3e8d30efd4aeda623dc9ade
